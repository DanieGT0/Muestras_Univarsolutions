...
export function KardexManagement() {
  ...
  const handleExportToExcel = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/export/kardex`, {
        method: 'GET',
        headers: {
      ...
      a.href = url;
      a.download = `kardex_${new Date().toISOString().split('T')[0]}.xlsx`;
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button variant="outline" onClick={handleExportToExcel} disabled={totalCount === 0}>
